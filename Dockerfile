...
RUN R -e "devtools::install_version('scales', '1.1.1', dependencies = T, repos = 'http://cran.r-project.org')"
RUN R -e "devtools::install_version('zeallot', '0.1.0', dependencies = T, repos = 'http://cran.r-project.org')"
