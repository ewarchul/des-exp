...
#' DES with PSR (Population Success Rule) step-size adaptation rule 
#'
#' http://www.loshchilov.com/publications/LMCMA.pdf
#' 

des_psr <- function(par, fn, ..., lower, upper, control = list()) {
